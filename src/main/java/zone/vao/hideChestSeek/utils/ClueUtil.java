...
public class ClueUtil {
  ...
  /**
   * Gets the applicable clues based on the materials found near the specified location.
   *
   * @param location The location to check for nearby materials.
   * @return A list of applicable clue messages.
   */
